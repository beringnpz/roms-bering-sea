...
!-----------------------------------------------------------------------
! depth correction	- EupS do better on the shelf
!-----------------------------------------------------------------------
...
!    &          (Bio(i,k,iMZS)**2) * cff2 * cff3 * cff4 * dtdays
...
!-----------------------------------------------------------------------
! depth correction EupO do better in deeper waters off shelf
!-----------------------------------------------------------------------
...
!=======================================================================
          ...
          ! 200 m the assunme die and become fast sinking detritus. 
	  ! If shallower that 200 m, when they hit the bottom, biomass remains in bottom layer. 
	  ! Uses zlimit to enforce 200-m limit when going down, and to prevent rising 
...
# ifdef CLIM_ICE_1D       
            ...
            aiceNfrac=cff1*exp(-inhib*BioBI(i,iIceNH4))+cff2   !nutrient limiting
...
!   
! Salinity impact on growth of Ice Algae
!   
...
# endif 
            ...
            GROWAice=grow1*min(aiceNfrac,aiceIfrac)
