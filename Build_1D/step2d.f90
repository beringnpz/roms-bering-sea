      MODULE step2d_mod
!
!svn $Id: step2d.F 895 2009-01-12 21:06:20Z kate $
!=======================================================================
...
!ajh add universal trap on zeta, similar to the wet-dry constraint
	zeta(i,j,knew)=max(zeta(i,j,knew),(0.1_r8-h(i,j)))
!
        END DO
      END DO
!
...
!
     ...
     &                           cff3*rvbar(i,j,ptsk)))*fac
        ...
        END DO
      END IF
!ajh prohibit ubar,vbar speeds above 10m/s
!
      DO j=Jstr,Jend
        DO i=IstrU,Iend
