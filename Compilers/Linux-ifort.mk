...
#            FFLAGS := -heap-arrays
# Limited debugging (fast)
             FFLAGS := -fp-model precise
# Trapping NaN and other fp errors
#              FFLAGS := -fp-model precise -fpe0 -ftz -traceback
# Finding out of bounds errors
#             FFLAGS := -fp-model precise -g -zero -CB -debug all -traceback
#
              CPP := /usr/bin/cpp
...
ifdef USE_NETCDF4
    NETCDF_INCDIR := /home/aydink/includeM
    NETCDF_LIBDIR := /home/aydink/libM
      HDF5_LIBDIR := /home/aydink/libM
else
    NETCDF_INCDIR := /home/aydink/includeM
    NETCDF_LIBDIR := /home/aydink/libM
endif
